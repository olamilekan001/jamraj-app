...
import img1 from "../assets/images/img-23.jpeg";
import img2 from "../assets/images/img-24.jpeg";
...
import img7 from "../assets/images/img-25.jpeg";
import img8 from "../assets/images/img-17.jpeg";
import img9 from "../assets/images/img-27.jpeg";
import img10 from "../assets/images/img-20.jpeg";
import img11 from "../assets/images/img-28.jpeg";
      ...
      <div className="custom-space-4">
        <div className="text-center">
          <h1 className="uppercase text-5xl font-bold leading-16">
            some of our <span className="text-[rgb(239,14,14)]">popular</span>{" "}
            <br />
            projects
          </h1>
        </div>

        <div className="grid lg:grid-cols-3 gap-8 portfolio-items">
